...
public static class BuildInTexture
{
    ...
    /// <summary>
    /// <br/>在这里注册所有震颤血条贴图,请在<see langword="Mod.Load"/>后修改该词典中文件
    /// <br/>Signed all Tremor health bar texture here,please modify it after it be signed in <see langword="Mod.Load"/>
    /// </summary>
    public static Dictionary<int, Asset<Texture2D>[]> TremorTextures = new Dictionary<int, Asset<Texture2D>[]>();

    /// <summary>
    /// <br/>在这里注册所有宇宙边界血条贴图,请在<see langword="Mod.Load"/>后修改该词典中文件
    /// <br/>Signed all UniverseEdge health bar texture here,please modify it after it be signed in <see langword="Mod.Load"/>
    /// </summary>
    public static Dictionary<int, Asset<Texture2D>[]> UniverseEdgeTextures = new Dictionary<int, Asset<Texture2D>[]>();
}
